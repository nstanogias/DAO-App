...
function CreateProposalButton() {
  const { setProposals } = useContext(ApiContext);
  ...
  return (
    <>
      {address && (
        <>
          <Icon onClick={onOpen} color='blue.500' w={10} h={10} as={CgAddR} cursor='pointer'></Icon>
          <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
              ...
              <ModalFooter>
                ...
                <Button colorScheme='pink' isLoading={isLoading} onClick={createProposalClicked}>
                  Create
                </Button>
              </ModalFooter>
            </ModalContent>
